...
## 相同点
基础的方面，都是适配了Rime输入法框架，支持全拼、双拼等多种输入方式，拼音词库全面（~~毕竟薄荷使用了雾凇词库~~<Badge type="tip" text="^2024.07" />薄荷使用了[白露拼音词库](https://github.com/gaboolic/rime-frost)，基于雾凇拼音并使用Python的jieba等方法重新分词训练；所以在拼音方面，体验类似）。
